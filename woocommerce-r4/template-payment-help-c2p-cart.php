...
<div class="br4_p2c_reference_field" id="br4_p2c_reference_field">
	...
	<input type="text" id="br4_p2c_phone" name="br4_p2c_phone" placeholder="0412-1234567" class="pya-grid-item" />
	...
	<div class="pya-grid-item pya-dni-container" style="display: flex; flex-direction: row;">
		...
		<input type="text" id="br4_p2c_dni" name="br4_p2c_dni" placeholder="Cédula" class="pya-grid-item" style="width: 100%;" />
	</div>
